      ...
      <div className="w-full max-w-xs">
        ...
        >
          ...
          <div className="mb-6">
            ...
            {/* Mensaje de error */}
            {errors.username && (
              <p role="alert" className="text-red-500 flex items-center gap-1">
          ...
          <button
            type="submit"
            className="w-full py-2 text-white font-semibold bg-gradient-to-r from-yellow-600 to-yellow-900 hover:from-yellow-500 hover:to-yellow-800 transition duration-300 rounded"
          >
            ENTER...
          </button>
        </form>
